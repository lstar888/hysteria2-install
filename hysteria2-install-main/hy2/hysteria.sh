...
insthysteria(){
    ...
    wget -N https://raw.githubusercontent.com/lstar888/hysteria-install/main/hy2/install_server.sh
...
EOF
    ...
    url="hysteria2://$auth_pwd@$last_ip:$last_port/?insecure=1&sni=$hy_domain#Hysteria2-l"
